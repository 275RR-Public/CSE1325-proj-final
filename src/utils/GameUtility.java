...
public class GameUtility {
    ...
    // get a Map's key by providing a value (reverse map)(ONLY FOR 1 to 1 mapping)
    ...
    //get the index of an array from its value (reverse mapping)
    public static int getIdxByValue(UUID[] arr, UUID search_value) {
